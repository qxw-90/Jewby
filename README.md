...
In the developer portal, set **App name** to `Jewby` and point Website / Terms / Privacy to the URLs above. Update the contact email in the docs if `jewby.support@gmail.com` is not your real inbox.
